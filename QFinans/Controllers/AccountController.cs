...
namespace QFinans.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        //[AllowAnonymous]
        [CustomAuth(Roles = "RegisterAccount")]
        public ActionResult Register()
        {
            var roles = db.Roles.OrderBy(x => x.Name).Select(x => new SelectListItem
            {
                Selected = false,
                Value = x.Name,
                Text = x.Name
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            ViewBag.Role = new SelectList(roles, "Value", "Text", model.RoleName);
            return View(model);
        }
